...
/**
 * The SkierEvent class is responsible for generating and holding
 * the details of a skier's event, including the resort ID, season ID,
 * day ID, and skier ID. These details are randomly generated for the skier.
 */
public class SkierEvent {
    ...
    /**
     * Constructs a SkierEvent with random values for resortID and skierID.
     * seasonID is set to "2024" and dayID is set to "1" by default.
     */
    public SkierEvent() {
